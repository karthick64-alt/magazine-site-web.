...
const templates = {
  header: `
    <nav class="navbar navbar-expand-lg bg-body border-bottom py-3 fixed-top">
      <div class="container">
...
function handleTrendingTabs() {
  ...
  // Initialize with the active tab's view
  const initialView = activeTab ? activeTab.dataset.trendingTab : "Week";
  renderTrending(initialView);
